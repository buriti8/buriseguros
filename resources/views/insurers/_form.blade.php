<form role="form" method="POST" action="{{ url('/admin/insurers' . ($insurers->id ? "/{$insurers->id}" : '')) }}"
            ...
            <div class="col-sm-4">
                ...
                <div class="input-group input-group-sm mb-2">
                    ...
                    <input id="name" type="text" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}"
                        name="name" value="{{ old('name', $insurers->name ?? '') }}"
            ...
            <div class="col-sm-4">
                ...
                <div class="input-group input-group-sm mb-2">
                    ...
                    <input id="link" type="text" class="form-control {{ $errors->has('link') ? 'is-invalid' : '' }}"
                        name="link" value="{{ old('link', $insurers->link ?? '') }}"
