<form class="form-inline" action="{{ route('networks.index') }}" method="get" role="search">
    <input type="hidden" name="per_page" value="{{$networks->perPage()}}" />
    <div class="col-sm-12 col-md-4">
        ...
        <div class="input-group input-group-sm mb-2">
            ...
            <input type="text" class="form-control" name="q[name]" value="{{$search['name'] ?? ''}}"
                placeholder="@lang('networks.name')" autocomplete="off">
        </div>
    </div>
    <div class="col-sm-12 col-md-4">
    ...
    <div class="col-sm-12 text-right">
        ...
        <a href="{{ route('networks.index', ['q' => []]) }}" class="btn btn-sm btn-primary mb-1">
