<form role="form" method="POST" action="{{ url('/admin/networks' . ($networks->id ? "/{$networks->id}" : '')) }}"
            ...
            <div class="col-sm-4">
                ...
                <div class="input-group input-group-sm mb-2">
                    ...
                    <input id="name" type="text" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}"
                        name="name" value="{{ old('name', $networks->name ?? '') }}"
            ...
            <div class="col-sm-4">
                ...
                <div class="input-group input-group-sm mb-2">
                    ...
                    <input id="link" type="text" class="form-control {{ $errors->has('link') ? 'is-invalid' : '' }}"
                        name="link" value="{{ old('link', $networks->link ?? '') }}"
            ...
            <div class="col-sm-4">
                ...
                <div class="input-group input-group-sm mb-2">
                    ...
                    <input id="icon" type="text" class="form-control {{ $errors->has('icon') ? 'is-invalid' : '' }}"
                        name="icon" value="{{ old('icon', $networks->icon ?? '') }}"
