                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td style="line-height: 24px; font-size: 16px; margin: 0;"
                                                                    align="left">
                                                                    <img class="w-24"
                                                                        src="{{ route('information.image', 1) }}?{{rand(0, 1000)}}"
                                                                        style="height: auto; line-height: 100%; outline: none; text-decoration: none; display: block; width: 100%; border-style: none; border-width: 0;"
                                                                        width="100">
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                            ...
                                                            <tr>
                                                                <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 40px;"
                                                                    ...
                                                                    <p class=""
                                                                        ...
                                                                        align="left">
                                                                        <strong>@lang('contact_forms.name'):&nbsp;</strong>{{$contact_form->name ?? ''}}
                                                                    </p>
                                                                    <p class=""
                                                                        style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;"
                                                                        align="left">
                                                                        <strong>@lang('contact_forms.phone'):&nbsp;</strong>{{$contact_form->phone ?? ''}}
                                                                    </p>
                                                                    <p class=""
                                                                        style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;"
                                                                        align="left">
                                                                        <strong>@lang('contact_forms.email'):&nbsp;</strong>{{$contact_form->email ?? ''}}
                                                                    </p>
                                                                    <p class=""
                                                                        style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;"
                                                                        align="left">
                                                                        <strong>@lang('contact_forms.insurance_id'):&nbsp;</strong>{{$contact_form->insurance->name ?? ''}}
                                                                    </p>
                                                                    <p class=""
                                                                        style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;"
                                                                        align="left">
                                                                        <strong>@lang('contact_forms.message'):&nbsp;</strong>{{$contact_form->message ?? ''}}
                                                                    </p>
                                                                    <table class="s-4 w-full" role="presentation"
                                                                        border="0" cellpadding="0" cellspacing="0"
                                                                        style="width: 100%;" width="100%">
